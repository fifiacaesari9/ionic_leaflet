...
//   }
  ...
  ionViewDidEnter() {
    this.map = L.map('mapId').setView([37.544614803079824, 127.04385430928153], 12);
  ...
  const baseMaps = {
   ...
   L.control.layers(baseMaps).addTo(this.map)
    ...
    const marker = L.marker([37.544614803079824, 127.04385430928153], { icon: markerIcon }).addTo(this.map).bindPopup('SM Entertainment').openPopup();
